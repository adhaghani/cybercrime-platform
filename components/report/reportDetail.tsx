...
export function ReportDetail({ reportId, showAdminActions = false, showAssignDialog = false }: ReportDetailProps) {
  ...
  return (
    <div className="space-y-6 mx-auto w-full max-w-7xl">
      {/* Header */}
      {showAdminActions && !isReportResolved && !isReportRejected && (
        <div className="w-full flex gap-2 justify-end">
          ...
          {isCurrentUserAssignedToThisReport && (
              ...
              <DialogContent className="max-w-2xl">
                ...
                <div className="space-y-4 py-4">
                  <div>
                    ...
                    <Textarea
                      id="action-taken"
                      placeholder="Describe the actions you've taken to address this report..."
          ...
          <Card>
            ...
            <CardContent className="space-y-0">
              {report.STAFF_ASSIGNED && report.STAFF_ASSIGNED.length > 0 ? (
                ...
                <p className="text-sm text-muted-foreground">This report was rejected and no staff were assigned.</p>
              ) : (
                ...
                {report.STAFF_ASSIGNED && report.STAFF_ASSIGNED.length > 0 ? (
                    ...
                    <div key={assignment.ASSIGNMENT_ID} className="flex items-center gap-2 p-2 rounded-lg bg-accent/50">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {assignment.ACTION_TAKEN ? "Completed" : "In Progress"}
                        </p>
                      </div>
                    </div>
                  ))
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">
                      This report was rejected and no staff were assigned.
                    </p>
                  </div>
                ) : (
              ...
              <div className="space-y-3">
                ...
                {report.STAFF_ASSIGNED && report.STAFF_ASSIGNED.length > 0 && (() => {
                  ...
                  report.STAFF_ASSIGNED.forEach(assignment => {
                    ...
                    if (assignment.UPDATED_AT && assignment.ACTION_TAKEN) {
                      events.push({
                        type: 'update',
                    ...
                    <div key={index} className="flex gap-3">
                      ...
                      <div className="flex-1 pb-4">
                        <p className="font-medium">
                          {event.type === 'assignment' 
                            ? `${event.assignment.NAME} assigned` 
                            : `${event.assignment.NAME} updated assignment`}
                        </p>
                        <p className="text-sm text-muted-foreground">
